 ...
 * @Date: 2023-02-26 15:28:20
 */
#include "ops/maxpooling_op.hpp"

namespace YAInfer {
MaxPoolingOp::MaxPoolingOp(uint32_t pooling_h, uint32_t pooling_w,
                           uint32_t stride_h, uint32_t stride_w,
                           uint32_t padding_h, uint32_t padding_w)
    : Operator(OpType::kOperatorMaxPooling),
      pooling_h_(pooling_h),
      pooling_w_(pooling_w),
      stride_h_(stride_h),
      stride_w_(stride_w),
...
uint32_t MaxPoolingOp::stride_width() const { return stride_w_; }
uint32_t MaxPoolingOp::stride_height() const { return stride_h_; }

uint32_t MaxPoolingOp::pooling_width() const { return pooling_w_; }
uint32_t MaxPoolingOp::pooling_height() const { return pooling_h_; }

uint32_t MaxPoolingOp::padding_width() const { return padding_w_; }
uint32_t MaxPoolingOp::padding_height() const { return padding_h_; }
